...
namespace Koop.Data.Migrations
{
    ...
    [Migration("20260722223532_FixAccountingDeleteBehaviors")]
    partial class FixAccountingDeleteBehaviors
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Koop.Entity.Entities.AccountingMonthlySummary", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("UserId", "VehicleId", "PeriodYear", "PeriodMonth")
                        .IsUnique()
                        .HasFilter("[UserId] IS NOT NULL AND [VehicleId] IS NOT NULL");

                    b.ToTable("AccountingMonthlySummaries");
                });
            ...
            modelBuilder.Entity("Koop.Entity.Entities.AccountingTransaction", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Koop.Entity.Entities.Vehicle", b =>
                {
                    b.Navigation("AccountingMonthlySummaries");
